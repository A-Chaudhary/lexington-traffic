...
def YOLO():
    ...
    # configPath = "C:/Yolo_v4/darknet/build/darknet/x64/cfg/yolov4.cfg"                                 # Path to cfg
    # weightPath = "C:/Yolo_v4/darknet/build/darknet/x64/yolov4.weights"                                 # Path to weights
    configPath = "C:/Users/chaud/Desktop/!Back_this_folder!/!Back_this_folder_up_old!/Coding and AI/python/Lexington Traffic Project/x64/cfg/yolov4-tiny.cfg"
    weightPath = "C:/Users/chaud/Desktop/!Back_this_folder!/!Back_this_folder_up_old!/Coding and AI/python/Lexington Traffic Project/x64/yolov4-tiny.weights"                                 # Path to weights
    metaPath = "C:/Users/chaud/Desktop/!Back_this_folder!/!Back_this_folder_up_old!/Coding and AI/python/Lexington Traffic Project/x64/cfg/coco.data"                                    # Path to meta data
        ...
        try:
            with open(metaPath) as metaFH:
                ...
                if match:
                    ...
                    result = 'C:/Users/chaud/Desktop/!Back_this_folder!/!Back_this_folder_up_old!/Coding and AI/python/Lexington Traffic Project/x64/data/coco.names'
                else:
                    result = None
                try:
            ...
            pass
    reduction_of_size_factor = 0.5
    # cap = cv2.VideoCapture(0)                                      # Uncomment to use Webcam
    cap = cv2.VideoCapture("C:\\Users\chaud\Desktop\!Back_this_folder!\!Back_this_folder_up_old!\Coding and AI\python\Lexington Traffic Project\media_77\media_w1682618446_22319.ts")                             # Local Stored video detection - Set input video
